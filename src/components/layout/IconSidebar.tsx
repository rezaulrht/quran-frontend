...
export function IconSidebar({ activeIndex = 0 }: IconSidebarProps) {
  return (
    <aside className="fixed left-0 top-0 z-20 flex h-full w-[50px] flex-col items-center bg-qm-bg py-3">
      {/* Logo */}
      <div className="mb-6 flex h-9 w-9 items-center justify-center rounded-md bg-qm-green-btn">
