...
export function AudioButton({ globalVerseNumber, surahName, verseNumber, onEnded }: AudioButtonProps) {
  const { isPlaying, isLoading, toggle } = useAudioPlayer(globalVerseNumber, surahName, verseNumber, onEnded)
